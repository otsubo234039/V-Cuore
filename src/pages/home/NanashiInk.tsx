  ...
  return (
    <div className={`absolute flex items-center justify-center transition-all duration-1000 ${
      ...
      <div className="relative w-full h-full flex items-center justify-center overflow-visible">
        ...
        {/* 2. 背景のインク：mask-imageを使って「実弾」で染める */}
        <div 
          className="absolute inset-0 opacity-80 animate-ink-spread"
          style={{
            // 🚀 粛清 2: インクの背景色を var(--oshi-primary) と同期。
            backgroundColor: 'var(--oshi-primary)',
            // PNGを「型紙」として使う技術アピールは維持や。
        ...
        <div className="relative z-10 animate-soft-float">
          {/* 🚀 影の色も shadow-oshi-primary/20 などにするとさらに品格が出るが、
              まずは標準の drop-shadow-2xl で「存在感」を確保しろ。 */}
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-[85%] h-[85%] drop-shadow-2xl">
            ...
            <path 
              d="M 60 170 
                  ...
                  Q 82 170 77 170 
                  Z" 
              // 🚀 粛清 3: fill を var(--oshi-primary) に差し替え。
              // これで N の本体もちみの選んだ色で輝き始める。
      ...
      {/* 🚀 CSS Variables への依存度を高めるため、アニメーション内の transform も維持 */}
      <style>{`
